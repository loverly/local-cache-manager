...
var tamper = require('../../lib/TamperDecoder')
var fs = require('fs')
var sys = require('sys')
...
exports.testLargeJson = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/large.json", 'utf8', function (err, data) {
...
exports.testSmallJson = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/small.json", 'utf8', function (err, data) {
        data = JSON.parse(data);
        seeds = t.unpackData(data);
...
exports.testSmall2Json = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/small2.json", 'utf8', function (err, data) {
        data = JSON.parse(data);
        seeds = t.unpackData(data);
        test.equal(seeds.length, 2, "Unpacks the correct number of items")
...
exports.testSparseJson = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/sparse.json", 'utf8', function (err, data) {
        data = JSON.parse(data);
        seeds = t.unpackData(data);
...
exports.testSparseStartJson = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/spstart.json", 'utf8', function (err, data) {
        data = JSON.parse(data);
        seeds = t.unpackData(data);
        test.equal(seeds.length, 5, "Unpacks the correct number of items")
...
exports.testRunJson = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/run.json", 'utf8', function (err, data) {
        data = JSON.parse(data);
        seeds = t.unpackData(data);
...
exports.testRun2Json = function(test){
    t = tamper.Tamper();
    var data, seeds;
    fs.readFile("./test-files/canonical-output/run2.json", 'utf8', function (err, data) {
        data = JSON.parse(data);
        seeds = t.unpackData(data);
