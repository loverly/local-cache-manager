...
CacheManager.prototype.setCategoricalSets = function setCategoricalSets(key, setsToSet) {
  var newValues,
    ...
    // new Values and the order in which they were cached by object id
    newValues = meta.serializedData;
    orderCachedById = meta.addedCounter;
    ...
    try {
      ...
      this._debug('Error has been hit. Max Limit Reached.');
      //collector.cleanUp(storageSpace, orderCachedById);
