...
* These public API methods are aimed at providing an easy to use method of serializing
...
*  standardizing each set in chunks of 3, each set is serialized, through the Tamper serialization
*  protocol. As the sets are serialized, a counter is added so that we also keep track of the order
*  each set was added.
*
*
*
