...
define('GarbageCollector',[],function(){
  /*
...
define('AbstractSerializer',[],function(){
...
define('ObjectSerializer',['./AbstractSerializer'], function(AbstractSerializer){
...
define('CacheManager',['./GarbageCollector', './ObjectSerializer'], function(garbageCollector, objectSerializer){
   ...
   *
   * */
  var CacheManager = function CacheManager(storageSpace) {
    this.storageSpace = storageSpace;
    this.collector = new garbageCollector;
    this.objectSerializer = new objectSerializer;
    //this.setSerializer = new setSerializer;
  ...
  CacheManager.prototype.getObject = function getObject(key, namespace) {
    ...
    cachedItemsNamespaced = storage.localStorage[namespace];
